...
class New_Toplevel:
    def __init__(self, top=None):
        ...
        genrei = StringVar(root)       
        ratingi = StringVar(root)       
        idu = StringVar(root)      
        nameu = StringVar(root)      
        yearu = StringVar(root)      
        dateu = StringVar(root)       
        langu = StringVar(root)       
        genreu = StringVar(root)        
        ratingu = StringVar(root)       
...
#        self.Label1.configure(text='''Label''')
        ...
        self.insert_genre.configure(textvariable = genrei)
        ...
        self.update_genre.configure(textvariable = genreu)
        ...
        self.insert_rating.configure(textvariable = ratingi)
        ...
        self.update_rating.configure(textvariable = ratingu)
        ...
        def insert():
            print("in insert")
            print(namei.get())
            iq.InsertQuries.columnInsert(idi, namei , genrei , datei ,yeari , langi ,ratingi)
            return
        
        def update():
            print("in update")
            print(nameu.get())
            iq.InsertQuries.columnUpdate(idu, nameu , genreu , dateu ,yearu , langu ,ratingu)
            return
        ...
        def getDelete():
            iq.InsertQuries.columnDelete(delete)
            return
