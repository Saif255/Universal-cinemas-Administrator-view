...
#        self.Label1.configure(text='''Label''')
        ...
        self.Label2.configure(text='''INSERT DATA IN CUSTOMER TABLE''')
        ...
        self.Label3i.configure(text='''Customer ID''')
        ...
        self.Label4i.configure(text='''CNIC''')
        ...
        self.Label10.configure(text='''UPDATE DATA IN Customer TABLE''')
        ...
        self.Label12.configure(text='''CNIC''')
        self.Label12.configure(width=82)


        self.Label14 = Label(self.Frame1)
        self.Label14.place(relx=0.49, rely=0.49, height=36, width=84)
        ...
        self.Label14.configure(text='''Customer ID    =''')
        ...
        self.Label19.configure(text='''DELETE DATA FROM CUSTOMER TABLE''')
        ...
        self.Label21.configure(text='''Customer''')
        ...
        self.Label23.place(relx=0.44, rely=0.76, height=36, width=90)
        ...
        self.Label23.configure(text='''Customer ID''')
        ...
        def insert():
            ...
            iq.InsertQuries.customerInsert(idi, namei )
        ...
        def update():
            print("in update")
            print(idi.get(), namei.get() )
            iq.InsertQuries.customerUpdate(idu, nameu)
        ...
        def getDelete():
            iq.InsertQuries.customerDelete(delete)
            return
