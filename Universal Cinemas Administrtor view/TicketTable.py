...
class New_Toplevel:
    def __init__(self, top=None):
        ...
        ticketidI = StringVar()
        movieidI = StringVar()
        customeridI = StringVar()
        dateI = StringVar()
        seatI = StringVar()
        theateridI = StringVar()
        ...
        self.Label2.configure(text='''Seat NO''')
        ...
        self.Label3.configure(text='''Movie ID''')
        ...
        self.Label4.configure(text='''Date & Time''')
        ...
        self.Label5.configure(text='''Theater ID''')
        ...
        self.Entry1.configure(textvariable = theateridI)
        ...
        self.Entry2.configure(textvariable = customeridI)
        ...
        self.Entry3.configure(textvariable = seatI)
        ...
        self.Entry4.configure(textvariable = movieidI)
        ...
        self.Entry5.configure(textvariable = dateI)
        ...
        self.Label6.configure(text='''Enter data in Ticket Table''')
        ...
        self.Label7.configure(text='''Seat NO''')
        ...
        self.Label8.configure(text='''Where    Customer ID    =''')
        ...
        self.Label9.configure(text='''Date & Time''')
        ...
        self.Label10.configure(text='''Theater ID''')
        ...
        self.Label11.configure(text='''Movie ID''')
        ...
        self.Label12.configure(text='''Update data in Ticket Table''')
        ...
        self.Entry7.configure(textvariable = dateU)
        ...
        self.Entry9.configure(textvariable = movieidU)
        ...
        self.Entry10.configure(textvariable = seatU)
        ...
        self.Label13.configure(text='''Delete data from Ticket Table''')
        ...
        self.Label17.configure(text='''Customer ID''')

        self.Label18 = Label(self.Frame1)
        self.Label18.place(relx=0.28, rely=0.78, height=26, width=42)
        ...
        self.Label18.configure(text='''Ticket''')

        def getInsertTick():
            iq.InsertQuries.ticketColumnInsert(customeridI , movieidI , dateI , theateridI , seatI ,ticketidI)
            return
        
        def updateTicket():
            print("in tick" + customeridU.get() , movieidU.get() , dateU.get() , theateridU.get() , seatU.get() ,ticketidU.get() )
            iq.InsertQuries.ticketUpdate(customeridU , movieidU , dateU , theateridU , seatU ,ticketidU)
            
        def deleteTicket():
            iq.InsertQuries.ticketDelete(delete)
        ...
        self.Button1.configure(command = getInsertTick)
        ...
        self.Button2.configure(command = updateTicket)
        ...
        self.Button3.configure(command = deleteTicket)
        ...
        self.Insert_TicketId.configure(textvariable= ticketidI)
        ...
        self.Label20.configure(text='''Ticket ID''')
        ...
        self.Label21.configure(text='''Ticket ID''')
        ...
        self.Entry13.configure(textvariable = ticketidU)
